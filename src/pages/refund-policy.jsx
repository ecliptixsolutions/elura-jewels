    ...
    <div className="section-spacing">
      ...
      <div className="section-shell">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <h2 className="text-xl font-medium mt-8 mb-3">6. Refund Process</h2>
          <ol className="list-decimal pl-5 text-gray-600 mb-3">
            <li>Email: info.elurajewels@gmail.com</li>
            <li>Provide order number and issue details</li>
            <li>Wait for approval</li>
            <li>Return item if required</li>
          </ol>
          ...
          <ul className="list-disc pl-5 text-gray-600 mb-3">
            ...
            <li>If the error is on our side, we will cover the shipping</li>
          </ul>
